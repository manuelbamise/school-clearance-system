...
const { prismaMock, mockTransaction, mockActivityLog, mockSendEmail } =
  vi.hoisted(() => {
    const prismaMock = {
      $transaction: vi.fn(),
      user: {
...
import { sendOtp, verifyOtp } from '../../src/otp/otp.service';
...
describe('otp.service', () => {
  ...
  describe('verifyOtp', () => {
    it('throws on wrong code', async () => {
      ...
      await expect(
        verifyOtp('user-1', 'test@example.com', '000000'),

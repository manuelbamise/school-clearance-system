...
import {
  LayoutDashboard, User, BookOpen, DollarSign, FileCheck, FolderOpen,
  Building2, Calendar, Users, BarChart3, FileText, UserCheck,
  Landmark, UserCog, Settings, ScrollText, PlusCircle, Bell,
  LogOut, ChevronLeft, GraduationCap, ClipboardList, Activity,
  Clock, AlertTriangle, TrendingUp, Award, ClipboardCheck,
} from 'lucide-react'
...
const iconMap: Record<string, React.ElementType> = {
  ...
  Building2, Calendar, Users, BarChart3, FileText, UserCheck,
  Landmark, UserCog, Settings, ScrollText, PlusCircle, Bell,
  LogOut, GraduationCap, ClipboardList, Activity, Clock,
  AlertTriangle, TrendingUp, Award, ClipboardCheck,
}

...
import {
  BookOpen, ClipboardList, FileCheck, Award, Building2, Users,
  DollarSign, Clock, TrendingUp, AlertTriangle, UserCheck,
  Landmark, Activity, Bell, BarChart3,
} from 'lucide-react'
...
export default function MetricCard({ data, index }: { data: MetricCardType; index: number }) {
  ...
  return (
    ...
    >
      {/* Gradient accent bar */}
      <div className={cn('absolute inset-x-0 top-0 h-1 bg-gradient-to-r', data.gradient || 'from-primary to-primary-light')} />

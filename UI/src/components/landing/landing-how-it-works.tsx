...
export default function LandingHowItWorks() {
  return (
    <section className="relative overflow-hidden bg-lp-deep py-20 max-[809px]:py-16" id="how-it-works">
          ...
          {steps.map((s, i) => (
            <Reveal key={s.title} delay={i * 120} className="h-full">
              <div className={stepCardCls}>
                ...
                <p className="mt-3 text-sm font-normal leading-[1.4] text-lp-muted">{s.body}</p>
                {i < steps.length - 1 && (

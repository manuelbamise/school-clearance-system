...
const particles = [
  ...
  { left: '12%', top: '30%', size: 4, type: 'gold', delay: 3.2, duration: 19, drift: -30, opacity: 0.5 },
  { left: '18%', top: '60%', size: 2, type: 'cyan', delay: 1.4, duration: 22, drift: 18, opacity: 0.6 },
  { left: '24%', top: '12%', size: 3, type: 'blue', delay: 5.1, duration: 17, drift: -22, opacity: 0.45 },
  { left: '33%', top: '74%', size: 2, type: 'gold', delay: 2.3, duration: 20, drift: 32, opacity: 0.5 },
  { left: '41%', top: '38%', size: 5, type: 'blue', delay: 7.4, duration: 24, drift: -18, opacity: 0.4 },
  { left: '49%', top: '88%', size: 3, type: 'cyan', delay: 4.6, duration: 18, drift: 24, opacity: 0.5 },
  { left: '57%', top: '22%', size: 2, type: 'gold', delay: 6.2, duration: 21, drift: -28, opacity: 0.55 },
  { left: '63%', top: '66%', size: 4, type: 'blue', delay: 1.9, duration: 23, drift: 20, opacity: 0.4 },
  { left: '71%', top: '10%', size: 3, type: 'cyan', delay: 8.3, duration: 19, drift: -24, opacity: 0.5 },
  { left: '78%', top: '52%', size: 2, type: 'gold', delay: 3.8, duration: 26, drift: 30, opacity: 0.45 },
  { left: '84%', top: '80%', size: 4, type: 'blue', delay: 5.7, duration: 20, drift: -20, opacity: 0.5 },
  { left: '90%', top: '28%', size: 3, type: 'cyan', delay: 2.8, duration: 22, drift: 22, opacity: 0.55 },
...
export default function LandingChangelog() {
  return (
    <section className="relative overflow-hidden bg-lp-black py-20 max-[809px]:py-16" id="changelog">
            ...
            <Reveal key={`${c.date}-${i}`} delay={i < 4 ? i * 60 : 0}>
              <div className="grid grid-cols-[128px_1fr] gap-6 border-b border-lp-line py-5 first:pt-0 last:border-b-0 max-[809px]:grid-cols-1 max-[809px]:gap-3">
                ...
                <div className="flex items-center gap-3 text-[15px] font-medium leading-[1.5] tracking-[-0.02em] text-lp-soft">
                  <span className={`h-2.5 w-2.5 flex-shrink-0 rounded-full shadow-[0_0_12px_currentColor] ${dotCls[c.type]}`} />
                  <span>{c.message}</span>
                </div>
              </div>
            </Reveal>
